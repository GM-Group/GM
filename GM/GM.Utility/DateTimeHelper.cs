...
namespace GM.Utility
{
    public class DateTimeHelper
    {
        ...
        public static string DateToStr(int offset)
        {
            return DateTime.Today.AddDays(offset).ToString("yyyy-MM-dd");
        }

        /// <summary>
        /// 返回标准日期格式string
        /// </summary>
        public static string GetDate(bool isShortTime = false)
        {
            return isShortTime ? DateTime.Now.ToString("yyyy年MM月dd日") : DateTime.Now.ToString("yyyy-MM-dd");
        }
        ...
        public static int StrDateDiffSeconds(string time, int Sec)
        {
            if (string.IsNullOrEmpty(time))
                return 1;
            DateTime dateTime = ConvertHelper.ToType<DateTime>(time);
        ...
        /// <returns>星期几，1代表星期一；0代表星期日</returns>
